...
Replace this legacy component with the [**Data Operations** component](./operations). Set **Input Type** to `JSON`.
...
Replace this legacy component with the [**Data Operations** component](./operations). Set **Input Type** to `JSON`, or the [**Loop** component](/loop).
...
<details>
<summary>JSON Operations, Table Operations, and Text Operations</summary>

Replace these legacy components with the [**Data Operations** component](./operations), which provides a unified interface for Text, JSON, and Table operations.
Set **Input Type** on the **Data Operations** component to match the data you need to process.
For more information, see the [**Data Operations** component](./operations) documentation.
...
Replace these legacy components with newer Processing components, such as the [**Data Operations** component](./operations) and [**Type Convert** component](/type-convert).
...
Replace this legacy component with the [**Data Operations** component](./operations). Set **Input Type** to `Table`, or the [**Parser** component](/parser).
