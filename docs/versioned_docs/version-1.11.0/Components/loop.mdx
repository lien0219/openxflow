...
For example, if you are looping over a `Table`, you could use multiple [**Data Operations** components](./operations) to conditionally filter data, and then run separate loops on each set of filtered data.
