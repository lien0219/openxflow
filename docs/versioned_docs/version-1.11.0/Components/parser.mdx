...
There are several ways you can address these inconsistencies:
    ...
    * Use other components to amend or filter anomalies before passing the data to the **Parser** component.
    There are many components you can use for this depending on your goal, such as the [**Data Operations** component](./operations), [**Structured Output** component](/structured-output), and [**Smart Transform** component](/smart-transform).
