...
replacements = {
    "binding.access_policy != ChannelAccessPolicy.INHERIT.value": (
        'getattr(binding, "access_policy", ChannelAccessPolicy.INHERIT.value) != ChannelAccessPolicy.INHERIT.value'
    ),
    "return binding.access_policy": ('return getattr(binding, "access_policy", ChannelAccessPolicy.INHERIT.value)'),
    ...
    "binding.context_mode != ChannelContextMode.INHERIT.value": (
        'getattr(binding, "context_mode", ChannelContextMode.INHERIT.value) != ChannelContextMode.INHERIT.value'
    ),
    "return binding.context_mode": ('return getattr(binding, "context_mode", ChannelContextMode.INHERIT.value)'),
