...
def test_get_mcp_setting_returns_default_before_service_initialization():
    with patch("lfx.base.mcp.util.get_settings_service", return_value=None):
        assert _get_mcp_setting("mcp_tool_execution_timeout", 180.0) == 180.0
