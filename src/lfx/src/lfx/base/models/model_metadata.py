...
MODEL_PROVIDER_METADATA: dict[str, Any] = {
    ...
    "DeepSeek": {
        "icon": "DeepSeek",
        "display_name_key": "modelProviders.providerNameDeepSeek",
        "max_tokens_field_name": "max_tokens",
        ...
        "variables": [
            ...
            {
                "variable_name": "DeepSeek API Base URL",
                "variable_key": "DEEPSEEK_BASE_URL",
                "description": "Optional. Defaults to https://api.deepseek.com.",
                "required": False,
                "is_secret": False,
                "is_list": False,
                "options": [],
                "langchain_param": "base_url",
                "component_metadata": {
                    "mapping_field": "openai_compatible_base_url",
                    "required": False,
                    "advanced": True,
                    "info": "Overrides the DeepSeek API endpoint for this node.",
                },
            },
        ],
    ...
    "Qwen": {
        ...
        "variables": [
            {
                "variable_name": "DashScope API Key",
                ...
                "component_metadata": {
                    ...
                    "required": False,
                    "advanced": True,
                    "info": "Falls back to DASHSCOPE_API_KEY environment variable",
                },
            },
            {
                "variable_name": "DashScope API Base URL",
                "variable_key": "DASHSCOPE_BASE_URL",
                "description": "Optional. Defaults to the DashScope OpenAI-compatible endpoint.",
                "required": False,
                "is_secret": False,
                "is_list": False,
                "options": [],
                ...
                "component_metadata": {
                    ...
                    "required": False,
                    "advanced": True,
                    "info": "Overrides the DashScope API endpoint for this node.",
                },
            },
        ],
        "api_docs_url": "https://help.aliyun.com/zh/model-studio/developer-reference/compatibility-of-openai-with-dashscope",
        "mapping": {
            "model_class": "ChatOpenAI",
            "model_param": "model",
        },
